...
namespace Neo.VM
{
    ...
    public class ExecutionEngine : IDisposable
    {
        ...
        /// <returns>Return True if are allowed, otherwise False</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual bool CheckBigIntegerByteLength(int byteLength) => byteLength <= MaxSizeForBigInteger;
                    ...
                    case OpCode.SYSCALL:
                        {
                            ...
                            if (Service?.Invoke(data, this) != true || !CheckStackSize(false, int.MaxValue))
                            {
                                State |= VMState.FAULT;
                                return;
                            }
